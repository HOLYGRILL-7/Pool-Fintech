...
export default function AdminProfileScreen() {
  ...
  const handleMenuItemPress = (title: string) => {
    Alert.alert(
      'Admin Control Panel',
      `The "${title}" console is currently under development.`,
      [{ text: 'OK' }]
    );
  };
      ...
      >
        ...
        <View style={styles.statsCard}>
          <View style={styles.statBox}>
            ...
            <Text style={styles.statValue}>8 Pools</Text>
          </View>
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity
            style={styles.menuItem}
            activeOpacity={0.7}
            onPress={() => handleMenuItemPress('Manage Members')}
          >
            <View style={styles.menuLeft}>
              <View style={styles.iconContainer}>
          ...
          <TouchableOpacity
            style={styles.menuItem}
            activeOpacity={0.7}
            onPress={() => handleMenuItemPress('System Security Configuration')}
          >
            <View style={styles.menuLeft}>
              <View style={styles.iconContainer}>
        ...
        <View style={styles.card}>
          <TouchableOpacity
            style={styles.menuItem}
            activeOpacity={0.7}
            onPress={() => handleMenuItemPress('System Notifications')}
          >
            <View style={styles.menuLeft}>
              <View style={styles.iconContainer}>
          ...
          <TouchableOpacity
            style={styles.menuItem}
            activeOpacity={0.7}
            onPress={() => handleMenuItemPress('Dashboard Theme')}
          >
            <View style={styles.menuLeft}>
              <View style={styles.iconContainer}>
        ...
        <View style={styles.card}>
          <TouchableOpacity
            style={styles.menuItem}
            activeOpacity={0.7}
            onPress={() => handleMenuItemPress('Admin Help Desk')}
          >
            <View style={styles.menuLeft}>
              <View style={styles.iconContainer}>
          ...
          <TouchableOpacity
            style={styles.menuItem}
            activeOpacity={0.7}
            onPress={() => handleMenuItemPress('System Log Records')}
          >
            <View style={styles.menuLeft}>
              <View style={styles.iconContainer}>
